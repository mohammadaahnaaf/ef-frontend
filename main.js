...
<nav>
    ...
    <div class="header-items">
        ...
        <!-- search  -->
        <div id="searchBox" style="display:none" class="search-boxs">
    ...
    <div class="right-icons">
        <svg id="cart" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
...
<div id="mobileMenu" style="display:none" class="mobile-menus">
<div class="mobile-items">

<button id="searchQ" class="mobile-search">
<svg id="mobile-srch" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
stroke="currentColor" class="menu-icon">
<path stroke-linecap="round" stroke-linejoin="round"
    d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
</svg>
...
const searcQ = document.getElementById('searchQ');
